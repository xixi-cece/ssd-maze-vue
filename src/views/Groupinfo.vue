<template>
    <div id="Groupinfo">
        <div class="wrapbox">
            <h3 class="headtip">
                <Icon type="ios-arrow-back" @click="goBack" />群内信息整理
            ...
            <div class="contBox">
                ...
                <div class="rowline">
                    <span class="labtile">整理日期：</span>
                    <span v-if="showtype==3"></span>
                    <DatePicker v-else type="date" :value="BaseInfo.date" @on-change="seleDate" placeholder="整理日期" style="width: 128px;"></DatePicker>
                </div>
                <div class="rowline">
                ...
                <div class="rowline">
                    <span class="labtile" style="width:120px;margin-bottom:5px;">近期待办事项<Icon v-if="showtype==1||showtype==2" @click="addItem" style="color:#34AA44;margin-left:5px;cursor:pointer;font-size:18px;" type="ios-add-circle-outline" /></span>
                ...
                <div class="rowline">
                    <span class="labtile" style="width:120px;margin-bottom:5px;">远期待办事项<Icon v-if="showtype==1||showtype==2" @click="addYqsx" style="color:#34AA44;margin-left:5px;cursor:pointer;font-size:18px;" type="ios-add-circle-outline" /></span>
                    <div class="labBox" v-if="showtype==3">
...
export default {
    ...
    methods: {
        ...
        isNull(){
            ...
            if(!date||!participants||!leading||!studentInfo||!mentorComments||!recentEvent||!futureEvent){
                return false;
            };
            return true;
        },
            ...
            if(this.showtype==3){//查看
                ...
                this.studenteditor.customConfig.uploadImgHooks = {
                    before: function (xhr, studenteditor, files) {
                        // 图片上传之前触发
                        // xhr 是 XMLHttpRequst 对象，studenteditor 是编辑器对象，files 是选择的图片文件
                    ...
                    success: function (xhr, studenteditor, result) {
                        ...
                        // xhr 是 XMLHttpRequst 对象，studenteditor 是编辑器对象，result 是服务器端返回的结果
                    ...
                    error: function (xhr, studenteditor) {
                        // 图片上传出错时触发
                        // xhr 是 XMLHttpRequst 对象，studenteditor 是编辑器对象
                    },
