    ...
    <div id="Readmoney">
        ...
        <div class="formBox">
            <Tabs :value="activeTab" @on-click='getTab'>
                <!-- <TabPane v-for="(item,j) in moneyList" :key="j" :label="tabsTabel(item)" :name="item.startDate+'-'+item.endDate" :disabled="item.isgray?true:false"> -->
                    ...
                    <div class="topBox">
                        <div class="lftbox">
                            <div class="itembox">
                                ...
                                <span class="bluespan">{{totalObj.monthlyWageCNY}}</span>
                            </div>
                            <div class="itembox">
        ...
        getData(){
            this.$https.checkWeek({
                ...
                if(res&&res.code==200){
                    ...
                    arr.forEach(itm=>{
                        itm.createDate = utility.framateDate(itm.createDate);
                        itm.workDate = utility.framateDate(itm.workDate);
                        const mintime = itm.workHours;
                        itm.workHours = mintime%60>0?(Math.floor(mintime/60)+'小时'+mintime%60+'分钟'):Math.floor(mintime/60)+'小时';
                    });
