<template>
    <div id="LeftMenu">
        <img class="menulogo" v-if="accoutype=='mentee'" src="../images/logo.png">
        <img class="menulogo" v-else src="../images/logo_white.png">
        <Tabs value="name1" v-if="accoutype=='sales'||accoutype=='saleshead'||accoutype=='salesvp'">
            <TabPane label="业务流程" name="name1">
                <Menu 
                    :theme="theme"
                    width="auto"
                ...
                >
                    <div v-for="(v,i) in menus" :key="i">
                        ...
                        <p v-if="accoutype!='sales'&&accoutype!='customizedmentor'&&accoutype!='specialist'&&accoutype!='intern'&&accoutype=='salesvp'&&i==4" class="line"></p>
                        <p v-if="accoutype!='sales'&&accoutype!='customizedmentor'&&accoutype!='specialist'&&accoutype!='intern'&&accoutype=='saleshead'&&i==2" class="line"></p>
                        <p v-if="accoutype=='salesvp'&&i==7" class="line"></p>
                    </div>
                </Menu>
            </TabPane>
            <TabPane label="处理中客户" name="name2">
                <Menu 
                    :theme="theme"
                    width="auto"
                    :active-name="activeMenu"
                ...
                >
                    <div v-for="(v,i) in menus" :key="i">
                        ...
                        <!-- 不展开无子菜单 -->
                        <!-- <Tooltip :content="v.val" placement="right" transfer>
                            <MenuItem :name="v.name" :to="v.path">
                                <Icon type="ios-appstore" />
                            </MenuItem>
                        </Tooltip> -->
                        <!-- 不展开有子菜单 -->
                        <!-- <Dropdown v-if="v.children" placement="right-start" transfer class="menu-dropdown">
                            <MenuItem :name="v.name" :to="v.path" >
                                <Icon type="ios-appstore" />
                            </MenuItem>
                            <DropdownMenu slot="list">
                                <DropdownItem v-for="(children, index) in v.children" :key="index" style="padding: 0 0; background-color:#515a6e;">
                                    <MenuItem :name="children.name" :to="children.path">{{ children.val }}</MenuItem>
                                </DropdownItem>
                            </DropdownMenu>
                        </Dropdown> -->
                    </div>
        ...
        <Tabs :value="checkMenu" v-else-if="accoutype=='opmentor'||accoutype=='ophead'||accoutype=='plhead'||accoutype=='plmentor'">
            <TabPane label="服务中客户" name="adname1">
                <Select
                    ...
                    <Option v-for="(option, index) in listmember" :value="option.username" :key="index">{{option.chinesename}}</Option>
                </Select>
                <Menu 
                    :theme="theme"
                    width="auto"
...
export default {
    ...
    created() {
        ...
        }else if(logintype=='opmentor'||logintype=='ophead'||logintype=='plmentor'||logintype=='plhead'){
        ...
        if(logintype=='sales'||logintype=='saleshead'||logintype=='salesvp'){
...
#LeftMenu{
    ...
    .ivu-menu-dark{
        ...
        .ivu-menu-item-active,.ivu-menu-item-selected{
            background: rgba(22,101,216,.3)!important;
            color: #fff;
        }
    ...
    .ivu-menu-light{
        ...
        .ivu-menu-item-active,.ivu-menu-item-selected{
            color: #1665D8;
            background-color: rgba(22,101,216,.3)!important;
        }
        .ivu-menu-item:hover,.ivu-menu-submenu-title:hover{
            color: #1665D8;
            background: rgba(22,101,216,.3);
        }
    }
    .line {
        height: 1px;
