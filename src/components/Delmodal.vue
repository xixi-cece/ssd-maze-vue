        ...
        >
            ...
            <div class="row_box">
                <div class="col_line">
                    ...
                    <div>{{dataInfo.workType}}</div>
                </div>
                <div class="col_line">
                    <span class="tigname">学员姓名</span>
                    <div>{{dataInfo.workType=='专项'?dataInfo.workType:dataInfo.menteeName}}</div>
                </div>
                <div class="col_line">
                    <span class="tigname">工作日期</span>
                    <div>{{dataInfo.workDate}}</div>
                </div>
            </div>
            <h4 class="titletig">是否删除该项已提交的工时？</h4>
            <div class="btnBox">
...
export default {
    ...
    methods: {
        oksure(){
            this.$emit('delstatu',1);
        },
        cancelbtn(){
            this.$emit('delstatu',0);
        },
        closeToast(e){
            ...
            //     }
            // }
            this.$emit('delstatu',0,this.dataInfo.id);
        }
    }
};
</script>
